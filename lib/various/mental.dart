...
import 'package:paper_one/BookMark/bookmark.dart';
...
//   return docs;
// });
final mentalItemsProviderTwo = StreamProvider<QuerySnapshot>((ref) {
...
class Mental extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final mentalItemsAsyncValue = ref.watch(mentalItemsProviderTwo);
    /////
    ////
    final bookmarksAsyncValue = ref.watch(bookmarksProvider);
    //
    //
    final isSubscribedIOSmental = ref.watch(inAppPurchaseManagerProvider);
    //
    //
    //
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          ref.refresh(mentalItemsProviderTwo);
        },
        child: mentalItemsAsyncValue.when(
          data: (snapshot) {
            //
            //
...
//特定アカウントの場合
                                    ...
                                    if (isSubscribedIOSmental.isSubscribed ==
                                        true) {

...
final humanItemsProviderTwo = StreamProvider<QuerySnapshot>((ref) {
...
class Human extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final humanItemsAsyncValue = ref.watch(humanItemsProviderTwo);
    /////
    ////
    final bookmarksAsyncValue = ref.watch(bookmarksProvider);
    //
    //
    final isSubscribedIOShuman = ref.watch(inAppPurchaseManagerProvider);
    //
    //
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          ref.refresh(humanItemsProviderTwo);
        },
        child: humanItemsAsyncValue.when(
          data: (snapshot) {
            //
            //
...
//特定アカウントの場合
                                    ...
                                    if (isSubscribedIOShuman.isSubscribed ==
                                        true) {

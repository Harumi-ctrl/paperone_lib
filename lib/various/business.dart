...
//   return docs;
// });
final businessItemsProviderTwo = StreamProvider<QuerySnapshot>((ref) {
...
class Business extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final businessItemsAsyncValue = ref.watch(businessItemsProviderTwo);
    //
    final bookmarksAsyncValue = ref.watch(bookmarksProvider);
    //
    // final businessItemsAsyncValueTwo = ref.watch(businessItemsProviderTwo);
    //
    //
    final isSubscribedIOSbusiness = ref.watch(inAppPurchaseManagerProvider);
    //
    //
    //
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          ref.refresh(businessItemsProviderTwo);
        },
        child: businessItemsAsyncValue.when(
          data: (snapshot) {
            //
            //
                            ...
                            child: IconButton(
                                ...
                                onPressed: () {
                                  if (user!.isAnonymous == false &&
                                      user != null) {
//特定アカウントの場合
                                    if (isSubscribedIOSbusiness.isSubscribed ==
                                        true) {
                                    ...
                                    } else if (isSubscribedIOSbusiness
                                            .isSubscribed ==
                                        false) {
                                      showDialog(
                                          context: context,

...
//   return docs;
// });
final foodsItemsProviderTwo = StreamProvider<QuerySnapshot>((ref) {
...
class Food extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final foodsItemsAsyncValue = ref.watch(foodsItemsProviderTwo);
    /////
    ////
    final bookmarksAsyncValue = ref.watch(bookmarksProvider);
    //
    //
    final isSubscribedIOSfood = ref.watch(inAppPurchaseManagerProvider);
    //
    //
    //
    //
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          ref.refresh(foodsItemsProviderTwo);
        },
...
//特定アカウントの場合
                                    ...
                                    if (isSubscribedIOSfood.isSubscribed ==
                                        true) {

...
//   return docs;
// });
final workoutItemsProviderTwo = StreamProvider<QuerySnapshot>((ref) {
...
class Workout extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final workoutItemsAsyncValue = ref.watch(workoutItemsProviderTwo);
    /////
    ////
    final bookmarksAsyncValue = ref.watch(bookmarksProvider);
    //
    //
    final isSubscribedIOSworkout = ref.watch(inAppPurchaseManagerProvider);
    //
    //
    //
    //
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          ref.refresh(workoutItemsProviderTwo);
        },
        child: workoutItemsAsyncValue.when(
          data: (snapshot) {
            //
            //
...
//特定アカウントの場合
                                    ...
                                    if (isSubscribedIOSworkout.isSubscribed ==
                                        true) {
                                    ...
                                    } else if (isSubscribedIOSworkout
                                            .isSubscribed ==
                                        false) {
                                      showDialog(
                                          context: context,
